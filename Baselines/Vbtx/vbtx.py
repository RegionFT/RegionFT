...
class Vbtx:
    def __init__(self, black_box_model, protected_list, no_train_data_sample, vbtx_ver="improved", show_logging=False):
    ...
    def test(self, runtime=None, max_test_data=None, label=("res", 0), disc_save_to="DiscData", test_save_to="TestData"):
        """run a fairness test
        ...
        Returns:
            the detected discriminatory instances and generated test cases will be saved to the directories given by disc_save_to and test_save_to
        """
